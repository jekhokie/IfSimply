class Lesson < ActiveRecord::Base
  ...
  validates_attachment :file_attachment,
    :content_type => { :content_type => /^(audio\/(mp3))|(application\/(vnd.openxmlformats-officedocument.spreadsheetml.sheet|vnd.openxmlformats-officedocument.spreadsheetml.template|vnd.openxmlformats-officedocument.presentationml.template|vnd.openxmlformats-officedocument.presentationml.slideshow|vnd.openxmlformats-officedocument.presentationml.presentation|vnd.openxmlformats-officedocument.presentationml.slide|vnd.openxmlformats-officedocument.wordprocessingml.document|vnd.openxmlformats-officedocument.wordprocessingml.template|vnd.ms-excel.addin.macroEnabled.12|vnd.ms-excel.sheet.binary.macroEnabled.12|pdf))|(text\/(plain|rtf))$/ },
